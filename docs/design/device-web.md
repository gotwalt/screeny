...
| 247 | **in progress** - the two things the owner saw on the button bench: the identify screen flickers over a live stream (older than the button), and the portal QR did not scan at brightness 56 | yes |
